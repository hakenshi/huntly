...
import { registerSchema, RegisterSchema } from "@/src/lib/zod/auth";
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br bg-zinc-950/50 flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-md">
                ...
                <Card className="bg-gradient-to-tl from-gray-900/40 to-transparent border border-gray-800/40 shadow-2xl">
